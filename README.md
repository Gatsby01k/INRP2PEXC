...
## Status
**Phase 0 — specification.** No production code yet. Documents are under review; open decisions are listed in [`docs/DECISIONS.md`](docs/DECISIONS.md).
...
| [STATE_MACHINES](docs/STATE_MACHINES.md) | Request, Quote, Trade, SettlementLeg, CryptoTransfer, Reservation, Exception, Adjustment |
...
| [DECISIONS](docs/DECISIONS.md) | Open questions with recommendations |
